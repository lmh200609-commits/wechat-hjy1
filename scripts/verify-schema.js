...
const requiredTables = {
  ...
  banners: ["id", "image_media_id", "link_type", "target_product_id", "visible", "sort_order"],
  collections: ["id", "code", "cover_media_id", "visible", "sort_order"],
  collection_products: ["collection_id", "product_id", "sort_order"],
  articles: ["id", "code", "cover_media_id", "body_json", "status", "published_at"],
  ...
  media_assets: ["id", "object_key", "url", "mime_type", "sha256", "status"],
